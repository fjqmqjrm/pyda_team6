...
![image](https://github.com/fjqmqjrm/pyda_team6/assets/126189239/c5bbd750-21fb-42e6-8c1b-6ac0c2ea577d)
...
### 사고유형별 사고차종에 따른 상해정도 비교 - 관련 파일 
```css
📂 pyda_team6 
    │
    ├─ 📂 data_visualization
    │  └─ accident_types_injury_visualization.py
    │
    ├─ 📂 data_analysis
    │  └─ accident_types_injury.py
    │
    ├─ 📂 data_processing 
    │  └─ data_load.py
    │
